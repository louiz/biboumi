        ...
        Scenario("persistent_channel_notify",
                 [
                     ...
                     partial(expect_unordered, [
                                ...
                                ("/message[@type='chat'][@to='{jid_one}'][@from='{biboumi_host}'][body[starts-with(text(), 'You were mentioned by {nick_two} in #foo%{irc_server_one}:')][contains(text(), '> Hey {nick_one}!')]][html/body/p/a[@href='xmpp:#foo%{irc_server_one}?join']][html/body/blockquote[text()='Hey {nick_one}!']]",)
                            ]),
