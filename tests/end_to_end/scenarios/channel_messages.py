...
scenario = (
    ...
    expect_stanza("/message[@from='#foo%{irc_server_one}/{nick_two}'][@to='{jid_one}'][@type='chat']/body[text()='yes']",
                  "/message/muc_user:x"),
    ...
    expect_stanza("/message[@from='#dummy%{irc_server_one}/{nick_two}'][@to='{jid_one}'][@type='chat']/body[text()='re']"),
